...
public class ActivityLoanSimBindingSw600dpImpl extends ActivityLoanSimBinding implements ltd.kaizo.realestatemanager.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.activity_loan_monthly_payments_title, 10);
        sViewsWithIds.put(R.id.activity_loan_total_interest_title, 11);
    }
    // views
    // variables
    @Nullable
    ...
    public ActivityLoanSimBindingSw600dpImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private ActivityLoanSimBindingSw600dpImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback11 = new ltd.kaizo.realestatemanager.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x80L) != 0) {
            ...
            this.activityLoanCalculateBtn.setOnClickListener(mCallback11);
